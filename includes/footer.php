        ...
        <div class="container">
            <div class="row">
                <div class="footer__container">
                    <img class="footer__img" src="image/logo/logo.svg" alt=""> Margaux Cacti & Succulents Corner
                    <hr class="line-break">
                    ...
                    <p class="footer__para">Copyright © 2022 - Margaux Cacti & Succulents Corner</p>
                </div>
            </div>
        </div>
    </section>
